...
import com.bezkoder.spring.files.upload.listener.UserJobExecutionNotificationListener;
import com.bezkoder.spring.files.upload.listener.UserStepCompleteNotificationListener;
import com.bezkoder.spring.files.upload.model.User;
import com.bezkoder.spring.files.upload.model.UserInput;
import com.bezkoder.spring.files.upload.repository.UserRepository;
...
public class BatchConfiguration {
    ...
    public FlatFileItemReader<UserInput> reader() {
        ...
        itemReader.setResource(new FileSystemResource("uploads/MOCK_DATA.csv"));
    ...
    private LineMapper<UserInput> lineMapper() {
        //LineMapper:Interface for mapping lines (strings) to domain objects typically used to
        // map lines read from a file to domain objects on a per line basis.
